...
import { automateAndOptimiseData, dataVisualizeTool, experiencetAndEngageData, pillersOfData } from "@/config/marketing";
                  ...
                  <div className="px-8 py-8 flex items-start justify-start gap-6 h-full flex-col shadow-lg">
                    ...
                    <ul className="flex flex-col items-start justify-between ">
                      {experiencetAndEngageData.map((item, index) => (
                        <li
                          key={index}
                          className="flex items-center justify-start gap-12 md:gap-16 py-6 border-b border-popover w-full last:border-b-0"
                        >
