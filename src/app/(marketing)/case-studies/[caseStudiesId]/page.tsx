  ...
  return (
    <>
      <section className="w-screen min-h-screen  items-center justify-center bg-background py-10 md:pt-64 md:pb-16 flex relative">
        ...
        <div className="flex items-center justify-between absolute bottom-[100px] left-[100px]">
          <div className="flex items-start flex-col justify-center gap-4 md:gap-4">
            <span className=" text-primary font-paragraph bg-transparent border border-foreground">
              {post.category ? post.category : ""}
            </span>
            <h2 className="font-heading text-secondary_heading text-primary leading-tight md:leading-[55px] max-w-5xl">
              {post.title ? post.title : ""}
            </h2>
            <span className="text-paragraph_heading text-primary font-paragraph bg-transparent max-w-2xl">
